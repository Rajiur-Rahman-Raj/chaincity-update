                ...
                <div class="row g-lg-5">
                    <div class="col-lg-8">
                        ...
                        <div id="amenities" class="video-box">
                            <h4 class="mb-4"><?php echo app('translator')->get('Video'); ?></h4>
                            <div class="row gy-4">
                                <iframe width="100%" height="100%"
                                        src="<?php echo e($singlePropertyDetails->video); ?>"
                                        frameborder="0"
                                ...
                                <div class="side-box">
                                    ...
                                    <ul class="profit-calculation">
                                        ...
                                        <li><?php echo app('translator')->get('Profit'); ?>:
                                            <span><?php echo e($singlePropertyDetails->profit_type == 1 ? $singlePropertyDetails->profit.'%' : config('basic.currency_symbol').$singlePropertyDetails->profit); ?></span>
                                        </li>
...
<?php echo $__env->make($theme.'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\chaincity_update\project\resources\views/themes/original/propertyDetails.blade.php ENDPATH**/ ?>