                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="text" name="name" value="<?php echo e(@request()->name); ?>" class="form-control"
                                       placeholder="<?php echo app('translator')->get('Search by Trx Number or User\'s name'); ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td data-label="<?php echo app('translator')->get('Method'); ?>">
                                ...
                                <?php if(optional($item->method)->is_automatic == 1): ?>
                                    <sup class="text-dark font-weight-bold"><?php echo app('translator')->get('Automatic'); ?></sup>
                                <?php endif; ?>
                            </td>
                            ...
                            <td data-label="<?php echo app('translator')->get('Status'); ?>">
                                <?php if($item->status == 2): ?>
                                    <span class="badge badge-pill badge-success"><?php echo app('translator')->get('Approved'); ?></span>
                                ...
                                <?php elseif($item->status == 4): ?>
                                    <span class="badge badge-pill badge-danger"><?php echo app('translator')->get('Fail'); ?></span>
                                <?php endif; ?>
                            </td>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="100%" class="text-cyan">
                                <p class="text-dark text-center"><?php echo app('translator')->get('No Data Found'); ?></p>
                            </td>
                        </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\chaincity_update\project\resources\views/admin/payout/logs.blade.php ENDPATH**/ ?>