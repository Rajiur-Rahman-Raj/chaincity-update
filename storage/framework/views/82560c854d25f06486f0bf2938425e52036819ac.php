                                            ...
                                            <span><i class="icon-check mr-2 text-primary"></i> <?php echo e(__(snake2Title($key))); ?> :
                                                ...
                                                <span>
                                                        ...
                                                        <img class="img-profile rounded-circle"
                                                             src="<?php echo e(asset('assets/upload/payoutFile').'/'.$value->fieldValue); ?>">
                                                    <?php else: ?>
                                                        <?php if($key == 'amount'): ?>
                                                            <span class="font-weight-bold text-dark">
                                                                <?php echo e(getAmount($value->fieldValue,8)); ?>

                                                            </span>
                                                        <?php else: ?>
                                                            <span class="font-weight-bold text-dark">
                                                            <?php echo e(__(@$value->fieldValue)); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\chaincity_update\project\resources\views/admin/payout/view.blade.php ENDPATH**/ ?>