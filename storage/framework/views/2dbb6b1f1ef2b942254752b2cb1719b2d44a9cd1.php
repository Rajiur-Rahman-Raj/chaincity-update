        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <?php if(adminAccessRoute(config('role.manage_property.access.view'))): ?>
                    ...
                    <li class="sidebar-item <?php echo e(menuActive(['admin.propertyList','admin.propertyCreate*', 'admin.propertyEdit*'],3)); ?>">
                        <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                            <i class="fa fa-building text-success"></i>
                            <span class="hide-menu"><?php echo app('translator')->get('Investment Properties'); ?></span>
                        </a>
                        <ul aria-expanded="false" class="collapse first-level base-level-line <?php echo e(menuActive(['admin.propertyCreate', 'admin.propertyEdit'],1)); ?>">
                            <li class="sidebar-item <?php echo e(menuActive(['admin.propertyCreate'])); ?>">
                                <a class="sidebar-link <?php echo e(menuActive(['admin.propertyCreate'])); ?>" href="<?php echo e(route('admin.propertyCreate')); ?>" aria-expanded="false">
                                    <span class="hide-menu"><?php echo app('translator')->get('Create New Property'); ?></span>
                                </a>
                            </li>
...
<?php /**PATH C:\xampp\htdocs\chaincity_update\project\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>