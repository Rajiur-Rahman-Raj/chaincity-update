                                            ...
                                            <div class="card mb-4 shadow">
                                                <div class="card-body">
                                                    <div class="row justify-content-between align-items-center">
                                                        ...
                                                        <div class="col-md-3"><a href="<?php echo e(route('admin.tawk.control')); ?>" class="btn btn-sm btn-primary btn-rounded" target="_blank"><?php echo app('translator')->get('Configuration'); ?></a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card mb-4 shadow">
                                                <div class="card-body">
                                                    <div class="row justify-content-between align-items-center">
                                                        ...
                                                        <div class="col-md-6"><?php echo app('translator')->get('Message your customers,they\'ll love you for it'); ?></div>
                                                        <div class="col-md-3"><a href="<?php echo e(route('admin.fb.messenger.control')); ?>" class="btn btn-sm btn-primary btn-rounded" target="_blank"><?php echo app('translator')->get('Configuration'); ?></a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card mb-4 shadow">
                                                <div class="card-body">
                                                    <div class="row justify-content-between align-items-center">
                                                        ...
                                                        <div class="col-md-3"><a href="<?php echo e(route('admin.google.recaptcha.control')); ?>" class="btn btn-sm btn-primary btn-rounded" target="_blank"><?php echo app('translator')->get('Configuration'); ?></a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card mb-4 shadow">
                                                <div class="card-body">
                                                    <div class="row justify-content-between align-items-center">
                                                        ...
                                                        <div class="col-md-3"><a href="<?php echo e(route('admin.google.analytics.control')); ?>" class="btn btn-sm btn-primary btn-rounded" target="_blank"><?php echo app('translator')->get('Configuration'); ?></a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp\htdocs\chaincity_update\project\resources\views/admin/plugin_panel/pluginConfig.blade.php ENDPATH**/ ?>