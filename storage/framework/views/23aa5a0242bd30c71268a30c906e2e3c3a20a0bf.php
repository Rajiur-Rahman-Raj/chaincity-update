...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-md-3 col-xl-3">
                                                ...
                                                <select name="amenity_id[]"
                                                        class="form-control propertyAmenities create-amenities <?php $__errorArgs = ['amenity_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                                        ...
                                        <div class="col-md-3 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <select name="how_many_days" id="how_many_days"
                                                        class="form-control create-profit-schedule <?php $__errorArgs = ['how_many_days'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php $__env->startPush('js'); ?>
    <?php echo $__env->make('partials.select2Create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <script>
        'use strict'
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\chaincity_update\project\resources\views/admin/property/create.blade.php ENDPATH**/ ?>